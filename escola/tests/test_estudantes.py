...
class EstudantesTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        # )
        self.estudante_01 = Estudante.objects.get(pk=4)
        ...
        #     celular='86 99999-9999'
        # )
        self.estudante_02 = Estudante.objects.get(pk=5)
    ...
    def test_requisicao_get_para_listar_um_estudante(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        dados_estudante = Estudante.objects.get(pk=4)
    ...
    def test_requisicao_delete_um_estudante(self):
        ...
        response = self.client.delete(f'{self.url}5/')
